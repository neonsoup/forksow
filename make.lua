...
msvc_obj_cxxflags( ".*", "/fp:fast" )
msvc_obj_cxxflags( ".*%.cpp", "/GR- /EHs-c-" )

gcc_obj_cxxflags( ".*", "-msse3 -ffast-math -fno-strict-aliasing -fno-strict-overflow -fvisibility=hidden" )
...
gcc_obj_cxxflags( ".*%.cpp", "-std=c++11 -fno-exceptions -fno-rtti" )
